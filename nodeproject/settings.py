...
DATABASES = {
    "default": {
        "ENGINE": env.str("DEFAULT_DB_ENGINE", default="django.db.backends.sqlite3"),
        "NAME": BASE_DIR / env.str("DEFAULT_DB_NAME", default="db.sqlite3"),
...
LOGGING = {
    ...
    "handlers": {
        "file": {
            ...
            "filename": BASE_DIR / "logs" / "app-logs.log",
            "formatter": "verbose",
        },
        "console": {
            "level": "DEBUG",
